...
namespace Infrastructure.Azure.Messaging
{
    ...
    /// </summary>
    /// <remarks>
    ///     Note that <see cref="Infrastructure.EventSourcing.IEventSourced" /> entities persisted through the
    ///     <see cref="IEventSourcedRepository{T}" />
    ///     do not use the <see cref="IEventBus" />, but has its own event publishing mechanism.
    /// </remarks>
