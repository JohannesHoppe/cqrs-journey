...
namespace Infrastructure.Azure.Messaging
{
    ...
    public class TopicSettings
    {
        ...
        public string XmlDuplicateDetectionHistoryTimeWindow {
            get { return DuplicateDetectionHistoryTimeWindow.ToString("hh:mm:ss"); }
            set { DuplicateDetectionHistoryTimeWindow = TimeSpan.Parse(value); }
        }

        public TopicSettings()
        {
            Subscriptions = new List<SubscriptionSettings>();
            MigrationSupport = new List<UpdateSubscriptionIfExists>();
        }
    }
